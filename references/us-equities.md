...
| 3 | NVDA | NVIDIA | Tech | GPU AI dominant, datacenter tăng trưởng >100%/năm |
| 4 | AMZN | Amazon | Consumer/Tech | AWS #1 cloud, e-commerce, ads growing |
| 5 | GOOG | Alphabet | Tech | Search ads, YouTube, Google Cloud, Waymo |
| 6 | META | Meta Platforms | Tech | Facebook/Instagram ads, WhatsApp, Reality Labs |
| 7 | BRK.B | Berkshire Hathaway | Finance | Diversified conglomerate, cash mountain |
| 8 | LLY | Eli Lilly | Healthcare | GLP-1 drugs (Mounjaro/Zepbound), pipeline mạnh |
| 9 | AVGO | Broadcom | Tech | Semiconductors + VMware, AI networking |
| 10 | JPM | JPMorgan Chase | Finance | Ngân hàng lớn nhất US, diversified |
| 11 | TSLA | Tesla | Consumer/Auto | EV leader, energy storage, FSD/robotaxi |
| 12 | V | Visa | Finance | Payment network, fee-based, global |
| 13 | UNH | UnitedHealth | Healthcare | Bảo hiểm + Optum health services |
| 14 | XOM | ExxonMobil | Energy | Oil major, Pioneer acquisition, dividend |
| 15 | MA | Mastercard | Finance | Payment duopoly với Visa |
| 16 | COST | Costco | Consumer Staples | Membership model, same-store sales growth |
| 17 | JNJ | Johnson & Johnson | Healthcare | Pharma + MedTech, dividend aristocrat |
| 18 | PG | Procter & Gamble | Consumer Staples | Consumer brands, dividend king |
| 19 | HD | Home Depot | Consumer Disc. | Home improvement #1, housing cycle |
| 20 | ABBV | AbbVie | Healthcare | Humira successor drugs, strong pipeline |
...
- **Rủi ro:** Slowing growth, private label competition

---

## P/E Benchmarks US Sectors (Historical Average)

| Sector | P/E thấp (rẻ) | P/E trung bình | P/E cao (đắt) | Forward P/E typical |
|--------|---------------|----------------|----------------|---------------------|
| Tech (mega) | < 20x | 25-30x | > 35x | 22-28x |
| Tech (growth) | < 25x | 30-45x | > 50x | 25-40x |
| Healthcare | < 13x | 16-20x | > 25x | 14-18x |
| Financials (banks) | < 8x | 10-13x | > 16x | 9-12x |
| Financials (payment) | < 20x | 25-30x | > 35x | 22-28x |
| Energy | < 8x | 10-14x | > 18x | 9-12x |
| Consumer Disc. | < 18x | 22-28x | > 35x | 20-25x |
| Consumer Staples | < 18x | 20-24x | > 28x | 18-22x |
...
1. **Mở tài khoản sàn quốc tế:**
   ...
   - **eToro** — dễ dùng, social trading, fractional shares
   - **Saxo Bank** — regulated tốt, nhiều thị trường
   - **Tiger Brokers / moomoo** — app mobile tốt, phí thấp

2. **Qua công ty chứng khoán VN:**
   - DNSE, Pinetree, SSI (có dịch vụ đầu tư quốc tế)
   - Phí cao hơn, thanh khoản qua broker trung gian

3. **ADR (American Depositary Receipt):**
   - Cổ phiếu nước ngoài niêm yết tại Mỹ
...
- **DCA hàng tháng** qua IBKR là chiến lược tốt nhất cho người mới
