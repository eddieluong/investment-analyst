...
|-----|-----------|---------------|-----|-----------|
| **VOO** | Vanguard S&P 500 | 0.03% | ~$400B+ | Phí thấp nhất, Vanguard = investor-owned |
| **SPY** | SPDR S&P 500 | 0.0945% | ~$500B+ | Cũ nhất (1993), thanh khoản cao nhất, options tốt |
...
- **Performance gần như giống nhau** — chênh lệch do expense ratio rất nhỏ

### S&P 500 Historical Returns:
- CAGR 10 năm: ~12-13%/năm (bao gồm dividend)
- CAGR 30 năm: ~10.5%/năm
- Max drawdown: -34% (2020 COVID), -57% (2008 GFC)
- Dividend yield: ~1.3-1.5%/năm

---

## NASDAQ 100 ETFs

| ETF | Expense Ratio | Đặc điểm |
|-----|---------------|-----------|
| **QQQ** | 0.20% | Invesco, cũ nhất NASDAQ 100, thanh khoản cao |
| **QQQM** | 0.15% | Invesco, phiên bản phí thấp hơn QQQ, tốt cho DCA |

### NASDAQ 100 vs S&P 500:
- **NASDAQ 100:** ~60% Tech, growth-oriented, volatile hơn
- **Return cao hơn:** CAGR 10 năm ~17-18%/năm (nhưng drawdown sâu hơn)
- **Phù hợp:** NĐT chấp nhận rủi ro cao, tin vào tech/AI
- **Không có:** Financials, Energy, Utilities (chỉ non-financial NASDAQ)

---

## VNM ETF — VanEck Vietnam
...
- ❌ NĐT tại VN → mua trực tiếp trên HOSE phí thấp hơn, chọn mã tốt hơn

---

## Emerging Markets ETFs

| ETF | Tên | Expense | Đặc điểm |
|-----|-----|---------|-----------|
| **VWO** | Vanguard FTSE EM | 0.08% | FTSE index, bao gồm China A-shares |
| **EEM** | iShares MSCI EM | 0.68% | MSCI index, cũ nhất, options tốt |
...
4. **South Korea:** ~12-15% (Samsung, SK Hynix)
5. **Brazil:** ~5-8% (Petrobras, Vale)
6. **Vietnam:** ~1-2% (sẽ tăng sau FTSE upgrade)

### EM vs DM Returns:
- EM CAGR 10 năm: ~4-6%/năm (underperform DM)
- Nhưng từ 2000-2010: EM outperform mạnh
- **Cyclical:** EM outperform khi USD yếu, commodities tăng

---

## Bond ETFs

| ETF | Loại | Yield | Duration | Đặc điểm |
|-----|------|-------|----------|-----------|
| **BND** | US Total Bond | ~4.5% | ~6 năm | Đa dạng bonds US, Vanguard |
| **AGG** | US Agg Bond | ~4.5% | ~6 năm | BlackRock, tương tự BND |
| **TLT** | US 20+ Year Treasury | ~4.5% | ~17 năm | Long-duration, volatile, FED play |
| **SHV** | Short Treasury | ~5.0% | <1 năm | Gần như cash, rủi ro thấp nhất |
...
Sau 20 năm (CAGR 12%): ~$495,000 (gốc $120,000, lãi ~$375,000)
Sau 30 năm (CAGR 12%): ~$1,750,000 (gốc $180,000, lãi ~$1,570,000)
```

### Rebalancing:
- **Mỗi 6-12 tháng** check lại tỷ trọng
- Nếu lệch > 5% → rebalance (bán ETF tăng nhiều, mua ETF giảm)
- **Tax-efficient:** Rebalance bằng cách điều chỉnh DCA thay vì bán
...
|-----|----------|---------|-----------|
| **VT** | Global All-Cap | 0.07% | US + DM + EM, 9000+ stocks |
